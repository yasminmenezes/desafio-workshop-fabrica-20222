          ...
          <div className="menu">
            <div className="logo">
              ...
              <p>
                ...
                you can visit knowing the ethical standards will be high.<br/><br/>Kagazoo 
                has a team of passionate conservationists working around-the-clock to 
                deliver animal experiences like no other.
              </p>
            </div>
          </div>
        </div>
